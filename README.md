...
- [Filter main cluster markers](#filter-main-cluster-markers)
...
- [Annotate unknown or ambiguous clusters](#annotate-unknown-or-ambiguous-clusters)
...
This file deals with the pre-processing of single-nucleus RNA seq data, dimension
...
``` r
# Retain cluster 4 subcluster markers with avg_log2FC threshold >= 0.1 and p_val_adj < 0.05 
